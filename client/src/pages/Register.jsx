...
const Register = () => {
  ...
  return (
    <div className="h-[90vh] flex items-center justify-center bg-black text-white">
      <div className="bg-neutral-900 p-8 rounded-xl shadow-lg w-full max-w-md border border-neutral-800">
